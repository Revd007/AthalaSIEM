...
import { useSigmaRules, useTestSigmaRule, useCreateSigmaRule } from '@/services/detection-rules-service'
...
export function SIGMARules() {
  ...
  const { data: rules, isLoading } = useSigmaRules()
  const testRuleMutation = useTestSigmaRule()
              ...
              {isLoading ? (
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    setRuleContent(rule.content || defaultSigmaRule)
                  }}
