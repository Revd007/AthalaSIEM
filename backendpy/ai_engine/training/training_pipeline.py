...
import json
from ..core.dataset_handler import UniversalDataset, CyberSecurityDataHandler, UniversalDatasetLoader
...
class TrainingPipeline:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.metrics = MetricsTracker(save_dir=config.get('metrics_dir', 'metrics'))
